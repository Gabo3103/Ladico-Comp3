...
const SCENARIO =
    "Estás analizando cómo se entrenan distintos sistemas de IA, debes identificar qué situaciones presentan desafíos éticos o legales. Lee cada caso y marca si no hay conflicto relevante, si existe un desafío ético, legal o ambos.";
