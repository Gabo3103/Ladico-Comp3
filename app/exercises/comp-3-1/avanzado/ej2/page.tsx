...
import DevelopExerciseA2, {
    type DevelopExerciseA2Handle,
} from "@/components/DevelopExerciseA2";

const COMPETENCE = "3.1";
const LEVEL = "avanzado";

export default function PageEj2_31_Avanzado() {
    const progressPct = (2 / 3) * 100;
    const exRef = useRef<DevelopExerciseA2Handle>(null);
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
                            ...
                            <div className="flex gap-3">
                                ...
                                <Button
                                    ...
                                    className="rounded-2xl bg-[#286675] px-6 py-2 font-medium text-white shadow-lg hover:bg-[#3a7d89]"
                                >
                                    <Link href="/exercises/comp-3-1/avanzado/ej3">Siguiente</Link>
                                </Button>
                            </div>
                        </div>
                    </CardContent>
