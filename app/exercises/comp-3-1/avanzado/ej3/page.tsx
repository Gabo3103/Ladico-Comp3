...
import DevelopExerciseA3, {
    type DevelopExerciseA3Handle,
} from "@/components/DevelopExerciseA3";

const COMPETENCE = "3.1";
const LEVEL = "avanzado";
const PREFIX = "session:3.1:Avanzado";

export default function PageEj3_31_Avanzado() {
    ...
    const exRef = useRef<DevelopExerciseA3Handle>(null);
    ...
    const handleFinish = async () => {
        ...
        setSaving(false);
        router.push(`/test/comp-3-1-avanzado?${qs.toString()}`);
    };
                    ...
                    <CardContent className="space-y-6 p-6 lg:p-8">
                        <div className="rounded-2xl border-l-4 border-[#286575] bg-gray-50 p-6">
                            <p className="text-gray-700">
                                Recibes distintas estructuras de borrador para un mismo recurso
                                digital. Debes elegir cuál se adapta mejor a la audiencia, el
                                objetivo, el tipo de lenguaje y el uso de imágenes.
                            </p>
                        </div>
                        <p className="inline-block rounded-full bg-blue-50 px-4 py-2 text-sm text-gray-600">
                            <b>Compara</b> las estructuras y selecciona el borrador más adecuado
                        </p>
