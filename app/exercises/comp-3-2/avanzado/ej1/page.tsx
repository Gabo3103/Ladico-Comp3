...
import IntegrationExerciseA1Audit, {
    type IntegrationExerciseA1AuditHandle,
} from "@/components/IntegrationExerciseA1Audit";

const COMPETENCE = "3.2";
const LEVEL = "avanzado";

export default function PageEj1_32_Avanzado() {
    const progressPct = (1 / 3) * 100;
    const exRef = useRef<IntegrationExerciseA1AuditHandle>(null);
                    ...
                    <CardContent className="space-y-6 p-6 lg:p-8">
                        <div className="rounded-2xl border-l-4 border-[#286575] bg-gray-50 p-6">
                            <p className="text-gray-700">
                                Debes crear un recurso digital que integre texto, datos, una cita
                                y elementos visuales provenientes de distintas fuentes, adecuado
                                a una audiencia específica
                            </p>
                        </div>

                        <p className="inline-block rounded-full bg-blue-50 px-4 py-2 text-sm text-gray-600">
                            <b>Elige</b> la mejor forma de integrar los contenidos y justifica tu decisión
                        </p>

                        <IntegrationExerciseA1Audit
                            ref={exRef}
                        ...
                        <div className="flex flex-wrap items-center justify-between gap-3 pt-2">
                            ...
                            <div className="flex gap-3">
                                ...
                                <Button
                                    ...
                                    className="rounded-2xl bg-[#286675] px-6 py-2 font-medium text-white shadow-lg hover:bg-[#3a7d89]"
                                >
                                    <Link href="/exercises/comp-3-2/avanzado/ej2">Siguiente</Link>
                                </Button>
                            </div>
                        </div>
                    </CardContent>
