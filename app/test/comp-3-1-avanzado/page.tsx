// app/test/comp-3-1-avanzado/page.tsx
"use client"
...
const PROGRESS_KEY = "ladico:3.1:avanzado:progress"
const SESSION_KEY = "session:3.1:Avanzado"
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      try {
        ...
        console.warn("No se pudo finalizar la sesión en resultados (3.1 Avanzado):", e)
      }
    })()
  }, [sid, correct, total])

  const handleBack = () => router.push("/dashboard")
  const handleRetry = () => router.push("/exercises/comp-3-1/avanzado/ej1")
              ...
              <div className="mt-8">
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 1: Comparación y justificación de propuestas de contenido</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 2: Decisión situacional de uso de herramientas</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 3: Selección de la mejor estructura de borrador</span>
                  </div>
