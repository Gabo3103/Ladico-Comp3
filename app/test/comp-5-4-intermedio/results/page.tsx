              ...
              <div className="mt-8">
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 1: Identificar el aprendizaje preventivo en cada caso</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 2: Armar el plan paso a paso ante un cambio</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 3: Elegir el tipo de aprendizaje según la necesidad</span>
                  </div>
