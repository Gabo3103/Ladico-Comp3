// app/test/comp-3-3-intermedio/page.tsx
"use client"
...
const PROGRESS_KEY = "ladico:3.3:intermedio:progress"
const SESSION_KEY = "session:3.3:Intermedio"
...
function ResultsIntermedioContent() {
  ...
  const competence = sp.get("competence") || "3.3"
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      try {
        ...
        console.warn("No se pudo finalizar la sesión en resultados (3.3 Intermedio):", e)
      }
    })()
  }, [sid, correct, total])

  const handleBack = () => router.push("/dashboard")
  const handleRetry = () => router.push("/exercises/comp-3-3/intermedio/ej1")
            ...
            <CardHeader className="bg-white">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mt-2 text-xs text-gray-500">
                  Competencia {competence} – Derechos de autor y licencias · Nivel{" "}
              ...
              <div className="mt-8">
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 1: Acciones permitidas según la licencia de cada recurso</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 2: Forma correcta de usar o compartir un recurso digital</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 3: Identificación de desafíos éticos y legales en el uso de IA</span>
                  </div>
