...
function ResultsIntermedioContent() {
  ...
  const handleRetry = () => router.push("/exercises/comp-5-3/intermedio/ej1")
              ...
              <div className="mt-8">
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 1: Emparejar situaciones con enfoque centrado en las personas</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 2: Completar oraciones sobre fortalezas, debilidades y ética de la IA</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 3: Seleccionar usos responsables de la tecnología</span>
                  </div>
