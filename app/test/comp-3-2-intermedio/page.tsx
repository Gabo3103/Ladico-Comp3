// app/test/comp-3-2-intermedio/page.tsx
"use client"
...
const PROGRESS_KEY = "ladico:3.2:intermedio:progress"
const SESSION_KEY = "session:3.2:Intermedio"
...
function ResultsIntermedioContent() {
  ...
  const competence = sp.get("competence") || "3.2"
  ...
  useEffect(() => {
    try {
      ...
      clearCaseSeeds(competence, level)
    } catch {
      /* no-op */
    }
    ...
    ;(async () => {
      ...
      try {
        ...
        console.warn("No se pudo finalizar la sesión en resultados (3.2 Intermedio):", e)
      }
    })()
  }, [sid, correct, total])

  const handleBack = () => router.push("/dashboard")
  const handleRetry = () => router.push("/exercises/comp-3-2/intermedio/ej1")
            ...
            <CardHeader className="bg-white">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mt-2 text-xs text-gray-500">
                  Competencia {competence} – Integración y reelaboración de contenido digital · Nivel{" "}
              ...
              <div className="mt-8">
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 1: Prácticas de integración responsable ausentes en una publicación</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 2: Adaptación de un contenido a nuevo formato y audiencia</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 3: Elección de la representación más clara de la información</span>
                  </div>
