// app/test/comp-3-2-avanzado/page.tsx
"use client"
...
const PROGRESS_KEY = "ladico:3.2:avanzado:progress"
const SESSION_KEY = "session:3.2:Avanzado"
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      try {
        ...
        console.warn("No se pudo finalizar la sesión en resultados (3.2 Avanzado):", e)
      }
    })()
  }, [sid, correct, total])

  const handleBack = () => router.push("/dashboard")
  const handleRetry = () => router.push("/exercises/comp-3-2/avanzado/ej1")
              ...
              <div className="mt-8">
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 1: Auditoría de integración multimodal (formato y justificación)</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 2: Uso ético, transparente y selectivo de herramientas digitales</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 3: Reelaboración de contenido complejo a un nuevo formato</span>
                  </div>
