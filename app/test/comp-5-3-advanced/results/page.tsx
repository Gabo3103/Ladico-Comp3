// app/test/comp-5-3-advanced/results/page.tsx
"use client"
...
const PROGRESS_KEY = "ladico:5.3:avanzado:progress"
const SESSION_KEY = "session:5.3:Avanzado"
const SIM_P3_STORAGE_KEY = "ladico:5.3:avanzado:ej3"
...
function ResultsAdvancedContent() {
  ...
  const competence = sp.get("competence") || "5.3"
  ...
  const handleRetry = () => router.push("/exercises/comp-5-3/avanzado/ej1")
            ...
            <CardHeader className="bg-white">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mt-2 text-xs text-gray-500">
                  Competencia {competence} – Uso creativo de las tecnologías digitales · Nivel{" "}
              ...
              <div className="mt-8">
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 1: Estrategia digital de una campaña solidaria</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 2: Guiar la creación de una encuesta en línea</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 3: Estrategia digital para vender en línea</span>
                  </div>
