// app/test/comp-5-1-advanced/results/page.tsx
"use client"
...
const PROGRESS_KEY = "ladico:5.1:avanzado:progress"
const SESSION_KEY = "session:5.1:Avanzado"
const SIM_P3_STORAGE_KEY = "ladico:5.1:avanzado:ej3"
...
function ResultsAdvancedContent() {
  ...
  const competence = sp.get("competence") || "5.1"
  ...
  const handleRetry = () => router.push("/exercises/comp-5-1/avanzado/ej1")
            ...
            <CardHeader className="bg-white">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mt-2 text-xs text-gray-500">
                  Competencia {competence} – Identificar y resolver problemas técnicos · Nivel{" "}
