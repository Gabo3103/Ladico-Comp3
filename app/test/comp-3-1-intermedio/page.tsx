// app/test/comp-3-1-intermedio/page.tsx
"use client"
...
const PROGRESS_KEY = "ladico:3.1:intermedio:progress"
const SESSION_KEY = "session:3.1:Intermedio"
...
function ResultsIntermedioContent() {
  ...
  const competence = sp.get("competence") || "3.1"
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      try {
        ...
        console.warn("No se pudo finalizar la sesión en resultados (3.1 Intermedio):", e)
      }
    })()
  }, [sid, correct, total])

  const handleBack = () => router.push("/dashboard")
  const handleRetry = () => router.push("/exercises/comp-3-1/intermedio/ej1")
            ...
            <CardHeader className="bg-white">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mt-2 text-xs text-gray-500">
                  Competencia {competence} – Desarrollo de contenidos digitales · Nivel{" "}
              ...
              <div className="mt-8">
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 1: Beneficios, limitaciones y uso ético de la IA</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 2: Secuencia del flujo de producción de contenido</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 3: Accesibilidad y revisión crítica de un recurso digital</span>
                  </div>
