// app/test/comp-5-4-advanced/results/page.tsx
"use client"
...
const PROGRESS_KEY = "ladico:5.4:avanzado:progress"
const SESSION_KEY = "session:5.4:Avanzado"
const SIM_P3_STORAGE_KEY = "ladico:5.4:avanzado:ej3"
...
function ResultsAdvancedContent() {
  ...
  const competence = sp.get("competence") || "5.4"
  ...
  const handleRetry = () => router.push("/exercises/comp-5-4/avanzado/ej1")
            ...
            <CardHeader className="bg-white">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mt-2 text-xs text-gray-500">
                  Competencia {competence} – Identificar y abordar necesidades de competencia digital · Nivel{" "}
              ...
              <div className="mt-8">
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 1: Apoyar la autonomía digital de un adolescente</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 2: Reunir aprendizajes según un propósito</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 3: Apoyo proporcional según cada necesidad</span>
                  </div>
