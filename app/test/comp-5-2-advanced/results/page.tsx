// app/test/comp-5-2-advanced/results/page.tsx
"use client"
...
const PROGRESS_KEY = "ladico:5.2:avanzado:progress"
const SESSION_KEY = "session:5.2:Avanzado"
const SIM_P3_STORAGE_KEY = "ladico:5.2:avanzado:ej3"
...
function ResultsAdvancedContent() {
  ...
  const competence = sp.get("competence") || "5.2"
  ...
  const handleRetry = () => router.push("/exercises/comp-5-2/avanzado/ej1")
            ...
            <CardHeader className="bg-white">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mt-2 text-xs text-gray-500">
                  Competencia {competence} – Identificación de necesidades y respuestas tecnológicas · Nivel{" "}
              ...
              <div className="mt-8">
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 1: Marcar las barreras de accesibilidad de un portal</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 2: Configurar apoyos de una videollamada según la app</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 3: Ajustar un panel de apoyo para poca experiencia</span>
                  </div>
