...
function ResultsIntermedioContent() {
  ...
  const handleRetry = () => router.push("/exercises/comp-5-2/intermedio/ej1")
              ...
              <div className="mt-8">
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 1: Elegir la función digital adecuada en cada fila</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 2: Ordenar los pasos de configuración de avisos</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 3: Seleccionar herramientas para tareas repetitivas</span>
                  </div>
