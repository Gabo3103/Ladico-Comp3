// app/test/comp-3-3-avanzado/page.tsx
"use client"
...
const PROGRESS_KEY = "ladico:3.3:avanzado:progress"
const SESSION_KEY = "session:3.3:Avanzado"
  ...
  useEffect(() => {
    ...
    ;(async () => {
      ...
      try {
        ...
        console.warn("No se pudo finalizar la sesión en resultados (3.3 Avanzado):", e)
      }
    })()
  }, [sid, correct, total])

  const handleBack = () => router.push("/dashboard")
  const handleRetry = () => router.push("/exercises/comp-3-3/avanzado/ej1")
              ...
              <div className="mt-8">
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 1: Usos compatibles con la licencia de una fotografía</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 2: Auditoría de casos de derechos de autor y uso de IA</span>
                  </div>
                ...
                >
                  <div className="flex items-center gap-2 text-gray-800">
                    ...
                    <span>Pregunta 3: Norma o directriz responsable ante casos complejos</span>
                  </div>
